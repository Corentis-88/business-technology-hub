...
export function R068CourseworkAssist({ topicId }: { topicId: string }) {
  ...
  return <section className="coursework-assist" aria-labelledby="coursework-assist-title">
    ...
    <section className="coursework-word-guide" aria-label="Suggested length"><div><span>MEA planning guide</span><strong>{guide.wordCountGuide}</strong></div><p>This is a rough guide to help you plan. OCR does not set a word count. Clear, relevant evidence matters more than writing extra words.</p></section>
