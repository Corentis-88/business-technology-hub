  ...
  return (
    <div className="blt-builder">
      <div className="blt-intro">
        <div><span className="eyebrow">BLT method · Pearson Business only</span><h2>Build an answer with BLT</h2><p>Make the business point first. Do not start a sentence with the word <strong>“because”</strong>.</p></div>
