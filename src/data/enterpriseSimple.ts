...
export const baselineEnterpriseSimpleGuides: SimpleTopicGuide[] = [
  ...
  },
  {
    ...
    sections: [
      { heading: "Risk, impact and response", simpleHeading: "What might go wrong and what can be done", explanation: ["A risk is something that may stop the proposal working well.", "Risks include competitors, lack of experience, making a loss, estimating demand incorrectly and spending too much.", "Outside changes in the economy, society, technology, law, politics or environment may also cause problems.", "Likelihood means how likely the risk is. Impact means how serious the result would be.", "The enterprise may use an experienced adviser, training, detailed research or a backup plan to reduce a problem."], steps: ["Name the exact risk.", "Judge its likelihood and possible impact.", "Put the biggest risks first.", "Choose an affordable response.", "Explain what problem may still remain."], example: "The owner may estimate demand too highly and buy too much stock. Better research and a smaller first order can lower this risk." },
...
export const baselineEnterpriseSimpleVisuals: Record<string, SimpleVisualSpec> = {
  ...
  "enterprise-r068-6:Risk, impact and response": { type: "flow", title: "Assess one risk", labels: ["Risk", "Likelihood", "Possible impact", "Response", "Problem left"], caption: "The response should fit how likely and harmful the risk is." },
...
const simpleDefinitions: Record<string, string> = {
  ...
  "Break-even": "The sales level where total revenue and total costs are equal.",
  ...
  "Grant": "Money given for a set purpose. It normally does not need to be repaid when the rules are followed.",
