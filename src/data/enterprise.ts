...
export const enterpriseCourse: Course = {
  ...
  units: [
          ...
          sections: [
            {
              ...
              paragraphs: [
                ...
                "Confidence helps an entrepreneur present ideas and make decisions, while determination helps them continue when a first attempt fails. A characteristic is explained fully only when it is connected to what it enables in the scenario.",
              ],
          ...
          sections: [
            {
              ...
              paragraphs: [
                "Research helps an enterprise understand customers and competitors, identify demand and gaps, reduce uncertainty and make informed decisions about products, prices, promotion and selling.",
    ...
    },
    {
      ...
      description: "Complete six steps to research, design and check an enterprise proposal. The practice activities use made-up examples.",
    ...
    },
    {
      ...
      topics: [
        ...
        topic({
          ...
          sections: [
            { heading: "Prepare for the audience", paragraphs: ["Plan for the audience, venue, resources, structure, visual aids and likely questions. Select evidence from the proposal, brand and campaign that supports a clear request or decision.", "Rehearse verbal clarity, pace, timing, eye contact, posture, gestures, use of notes and transitions. Record specific feedback from the practice and evidence of what changed."], visual: { kind: "pitch-journey", title: "Practice into performance", caption: "A rehearsal has value when evidence leads to a specific change and another check.", labels: ["Plan", "Resources", "Rehearse", "Feedback", "Change", "Recheck"] } },
