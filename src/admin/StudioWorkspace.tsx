...
const nav: Array<{ id: StudioView; label: string; description: string; icon: typeof Home }> = [
  { id: "visual", label: "Edit website", description: "Drag and edit the page you see", icon: LayoutDashboard },
