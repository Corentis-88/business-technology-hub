...
export function TopicPage() {
  ...
  return (
    <div className="topic-page" style={{ "--course-accent": course.accent } as React.CSSProperties}>
      ...
      <div className="page-section topic-support-copy"><HeartHandshake /><p>{course.id === "enterprise" ? "If the lesson words feel difficult, choose Say it simpler. You will get the same topic in shorter steps, with easy examples and course words explained." : "You're in the right place. Work through one connection at a time, and use the vocabulary links whenever you want to return to the explanation behind a term."}</p></div>
